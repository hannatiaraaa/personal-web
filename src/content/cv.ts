...
export const summary: readonly string[] = [
  `Six years of production experience building and owning software across mobile, web, backend and delivery infrastructure, remote and hybrid across Indonesia and Singapore. TypeScript, React Native/Expo, Next.js and NestJS, with particular experience in offline-first applications, permission-heavy workflows, and systems where correctness directly affects operations and money.`,
  `Built a field-operations SaaS from its early stage to ${figures.vessels} vessels in production across ${figures.customerOrgs} large customer organisations, growing from frontend and mobile development into end-to-end technical ownership. I define requirements, shape architecture and data models, build APIs and applications, and own the automated checks and release standards for the domain.`,
  `Across ${figures.mergedPullRequests} merged pull requests and ${figures.reviewsGiven} code reviews, in monorepos and multi-repo systems, conventionally and AI-assisted. The focus is making complex software predictable: decisions documented, changes tested, permissions verified, releases held to a written standard. Milestone-sized features that previously took one to three months and a small team now ship in weeks.`,
];

export const highlights: readonly string[] = [
  `Took a field-operations SaaS from its first months to ${figures.vessels} vessels in production across ${figures.customerOrgs} large corporate clients as founding engineer, with ${figures.workstreamsOwned} workstreams owned end to end.`,
...
export const roles: readonly Role[] = [
  {
    ...
    organisationNote: 'a venture of Wintermar Offshore Marine Group Tbk · employment of record: Software Engineer, Wintermar Offshore Marine Group Tbk',
    period: 'Jan 2024 – Present',
    location: 'Jakarta, Indonesia',
    context: `Field-operations and planned-maintenance platform used across ${figures.vessels} offshore vessels and ${figures.customerOrgs} customer organisations: an offline-first tablet app for crews at sea where there is no signal, a back-office web app for shore staff, and a vendor portal. Joined in the product's first months, initialising the first codebases as a frontend engineer, and grew into the full path — requirements, data model and architecture through API, apps, release engineering and production support.`,
    bullets: [
